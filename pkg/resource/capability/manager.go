...
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=capabilities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.services.k8s.aws,resources=capabilities/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"ACTIVE", "CREATE_FAILED", "DELETE_FAILED"}
