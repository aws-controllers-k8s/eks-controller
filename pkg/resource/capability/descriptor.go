...
const (
	FinalizerString = "finalizers.eks.services.k8s.aws/Capability"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("capabilities")
