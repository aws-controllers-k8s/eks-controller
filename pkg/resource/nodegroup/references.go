...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.RemoteAccess != nil {
		if len(desiredKO.Spec.RemoteAccess.SourceSecurityGroupRefs) > 0 {
			if latestKO.Spec.RemoteAccess == nil {
				latestKO.Spec.RemoteAccess = &svcapitypes.RemoteAccessConfig{}
			}
			if len(latestKO.Spec.RemoteAccess.SourceSecurityGroupRefs) == 0 {
				latestKO.Spec.RemoteAccess.SourceSecurityGroupRefs = desiredKO.Spec.RemoteAccess.SourceSecurityGroupRefs
			}
		}
	}
