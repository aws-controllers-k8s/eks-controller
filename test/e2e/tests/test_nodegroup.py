...
from e2e.common import (
    ...
    TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_34,
    TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_35,
)
...
def simple_nodegroup(eks_client, simple_cluster) -> Tuple[k8s.CustomResourceReference, Dict]:
    ...
    replacements["K8S_VERSION"] = TESTS_DEFAULT_KUBERNETES_VERSION_1_34
    replacements["RELEASE_VERSION"] = TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_34
    ...
    def test_update_nodegroup_version(self, simple_nodegroup, eks_client):
        ...
        updates = {
            "spec": {
                ...
                "releaseVersion": TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_35,
            }
        }
        k8s.patch_custom_resource(ref, updates)
        time.sleep(MODIFY_WAIT_AFTER_SECONDS)
        ...
        assert aws_res["nodegroup"]["version"] == TESTS_DEFAULT_KUBERNETES_VERSION_1_35
        assert aws_res["nodegroup"]["releaseVersion"] == TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_35

        # Assert terminal condition is set to True
        updates = {
            "spec": {
                "version": TESTS_DEFAULT_KUBERNETES_VERSION_1_34,
                "releaseVersion": TESTS_DEFAULT_KUBERNETES_RELEASE_VERSION_1_35,
            }
        }
